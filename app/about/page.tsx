...
export default function AboutPage() {
  useEffect(() => {
    // UnicornStudio script loading remains the same
      ...
      <section className="bg-background py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-montagu-slab font-bold mb-4">About HungryZhub</h2>
            <p className="text-xl font-montaga text-muted-foreground max-w-3xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-card p-6 rounded-lg border">
              <h3 className="text-2xl font-montagu-slab font-bold mb-4">Our Mission</h3>
              <p className="font-montaga text-muted-foreground leading-relaxed">
            ...
            {/* What We Do */}
            <div className="bg-card p-6 rounded-lg border">
              <h3 className="text-2xl font-montagu-slab font-bold mb-4">What We Do</h3>
              <ul className="space-y-3 font-montaga text-muted-foreground">
          ...
          {/* Our Values */}
          <div className="mb-16">
            <h3 className="text-3xl font-montagu-slab font-bold text-center mb-8">Our Core Values</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-card p-6 rounded-lg border text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🤝</span>
                </div>
                <h4 className="text-xl font-montagu-slab font-semibold mb-3">Inclusivity</h4>
                <p className="font-montaga text-muted-foreground">
              ...
              <div className="bg-card p-6 rounded-lg border text-center">
                ...
                <h4 className="text-xl font-montagu-slab font-semibold mb-3">Innovation</h4>
                <p className="font-montaga text-muted-foreground">
              ...
              <div className="bg-card p-6 rounded-lg border text-center">
                ...
                <h4 className="text-xl font-montagu-slab font-semibold mb-3">Community</h4>
                <p className="font-montaga text-muted-foreground">
          ...
          <div className="bg-gradient-to-r from-primary/5 to-secondary/5 p-8 rounded-lg">
            <h3 className="text-3xl font-montagu-slab font-bold text-center mb-8">Why Choose HungryZhub?</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl">👥</span>
                </div>
                <h4 className="font-montagu-slab font-semibold mb-2">Student-Centric Design</h4>
                <p className="text-sm font-montaga text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h4 className="font-montagu-slab font-semibold mb-2">Local Discovery</h4>
                <p className="text-sm font-montaga text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h4 className="font-montagu-slab font-semibold mb-2">Social Connection</h4>
                <p className="text-sm font-montaga text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h4 className="font-montagu-slab font-semibold mb-2">Real-Time Updates</h4>
                <p className="text-sm font-montaga text-muted-foreground">
